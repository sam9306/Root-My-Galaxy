...
The no-BTF Android 5.4.289 procedure and legacy `rt_mutex_waiter` layout are
recorded separately in
[`SM-G9900-G9900ZHSKIZE1.md`](SM-G9900-G9900ZHSKIZE1.md).
...
model: SM-G9900
region: BRI
AP/PDA: G9900ZHSKIZE1
CSC: G9900OZSKIZE1
CP: G9900ZHSKIZE1
display build: BP2A.250605.031.A3.G9900ZHSKIZE1
fingerprint: samsung/r9qzh/qssi:16/BP2A.250605.031.A3/G9900ZHSKIZE1:user/release-keys
kernel release: 5.4.289-android16-12
```

Query Samsung FUS with `samloader-rs`:

```powershell
samloader.exe check-update --model SM-G9900 --region BRI --all --verbose
```

The returned four-part version for this port was:

```text
G9900ZHSKIZE1/G9900OZSKIZE1/G9900ZHSKIZE1/G9900ZHSKIZE1
```
...
samloader.exe download `
  --model SM-G9900 `
  --region BRI `
  --version "G9900ZHSKIZE1/G9900OZSKIZE1/G9900ZHSKIZE1/G9900ZHSKIZE1" `
  --threads 16 `
  --out-file G9900ZHSKIZE1_BRI.zip `
  --verbose
```
...
```powershell
tar -xf G9900ZHSKIZE1_BRI.zip AP_G9900ZHSKIZE1_G9900ZHSKIZE1_MQB110011976_REV00_user_low_ship_MULTI_CERT_meta_OS16.tar.md5
tar -xf AP_G9900ZHSKIZE1_G9900ZHSKIZE1_MQB110011976_REV00_user_low_ship_MULTI_CERT_meta_OS16.tar.md5 boot.img.lz4 vendor_boot.img.lz4
```
...
boot.img SHA-256: 889d67f81b87f771fabf2d4d25c94b094ba9eb776f28438c5f43ec19e62dffbe
kernel size: 52490752
kernel SHA-256: 0d1f57a50fcbf6155aa13d4bcd544c9de464b007bf05f0538210ea43a58357ee
